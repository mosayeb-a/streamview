...
import com.ma.streamview.common.ACCESS_TOKEN_KEY
...
class MediaLocalDataSource(
    ...
    private val db by lazy {
        StreamDatabase(driver = AndroidSqliteDriver(StreamDatabase.Schema, context, "stream.db"))
    }
    ...
    override fun saveToken(token: String) {
        preferences.putString(ACCESS_TOKEN_KEY, token)
    }
